...
if __name__ == "__main__":
    for num_pods in [6, 8, 10, 12, 14, 16]:
        ...
        with open("./benchmarks/fattree/fattree_{}_pods_reachability_1.json".format(num_pods), 'w') as f:
            json.dump(recursive_variables, f, ensure_ascii=False, indent=4)

        recursive_variables['properties'] = {'1': all_properties['1']}
        with open("./benchmarks/fattree/fattree_{}_pods_reachability_2.json".format(num_pods), 'w') as f:
            json.dump(recursive_variables, f, ensure_ascii=False, indent=4)

        recursive_variables['properties'] = {'2': all_properties['2']}
        with open("./benchmarks/fattree/fattree_{}_pods_waypointing.json".format(num_pods), 'w') as f:
            json.dump(recursive_variables, f, ensure_ascii=False, indent=4)

        recursive_variables['properties'] = all_properties
        with open("./benchmarks/fattree/fattree_{}_pods_all_properties.json".format(num_pods), 'w') as f:
            json.dump(recursive_variables, f, ensure_ascii=False, indent=4)
